...
package com.mario.gank.ui.adapter;
...
import com.mario.gank.constant.UrlMatch;
import com.mario.gank.utils.DateUtils;
import com.mario.gank.utils.GlideUtils;
import com.mario.gank.widget.RatioImageView;
...
public class MainAdapter extends EasyRecyclerViewAdapter {
    ...
    private void loadingDaily(EasyRecyclerViewHolder easyRecyclerViewHolder, int position) {
        ...
        if (dailyData.category == null) {
            ...
            if (dailyData.category.contains(ApiConstant.DATA_TYPE_ANDROID)) {
                androidTagTV.setVisibility(View.VISIBLE);
            } else {
                androidTagTV.setVisibility(View.GONE);
            }
            if (dailyData.category.contains(ApiConstant.DATA_TYPE_IOS)) {
                iOSTagTV.setVisibility(View.VISIBLE);
            } else {
                iOSTagTV.setVisibility(View.GONE);
            }
            if (dailyData.category.contains(ApiConstant.DATA_TYPE_JS)) {
