...
import com.mario.gank.core.BaseDrawerLayoutActivity;
import com.mario.gank.ui.adapter.MainAdapter;
    ...
    @Override public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.menu_main_home_page:
                EasyWebViewActivity.toUrl(this, ApiConstant.GANK_HOME_PAGE_URL,
                        ApiConstant.GANK_HOME_PAGE_NAME);
                return true;
