...
public class GankTypeDict {
    ...
    static {
        ...
        type2UrlTypeDict.put(GankType.welfare, ApiConstant.DATA_TYPE_WELFARE);
        type2UrlTypeDict.put(GankType.android, ApiConstant.DATA_TYPE_ANDROID);
        type2UrlTypeDict.put(GankType.ios, ApiConstant.DATA_TYPE_IOS);
        type2UrlTypeDict.put(GankType.video, ApiConstant.DATA_TYPE_REST_VIDEO);
        type2UrlTypeDict.put(GankType.resources, ApiConstant.DATA_TYPE_EXTEND_RESOURCES);
        type2UrlTypeDict.put(GankType.js, ApiConstant.DATA_TYPE_JS);
        type2UrlTypeDict.put(GankType.app, ApiConstant.DATA_TYPE_APP);
        type2UrlTypeDict.put(GankType.recommend, ApiConstant.DATA_TYPE_RECOMMEND);
        for (Map.Entry<Integer, String> entry : type2UrlTypeDict.entrySet()) {
            urlType2TypeDict.put(entry.getValue(), entry.getKey());
        }

        urlType2ColorDict.put(ApiConstant.DATA_TYPE_WELFARE, 0xffFFAEC9);
        urlType2ColorDict.put(ApiConstant.DATA_TYPE_ANDROID, 0xff388E3C);
        urlType2ColorDict.put(ApiConstant.DATA_TYPE_IOS, 0xff0377BC);
        urlType2ColorDict.put(ApiConstant.DATA_TYPE_REST_VIDEO, 0xff039588);
        urlType2ColorDict.put(ApiConstant.DATA_TYPE_EXTEND_RESOURCES, 0xff546E7A);
        urlType2ColorDict.put(ApiConstant.DATA_TYPE_JS, 0xffEF6C02);
        urlType2ColorDict.put(ApiConstant.DATA_TYPE_APP, 0xffC02E34);
        urlType2ColorDict.put(ApiConstant.DATA_TYPE_RECOMMEND, 0xff4527A0);
    }
}
